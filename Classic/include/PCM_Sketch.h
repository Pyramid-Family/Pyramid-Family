...
public:
	PCM_Sketch(int _word_num, int _d, int word_size, int hash_seed);
...
PCM_Sketch::PCM_Sketch(int _word_num, int _d, int word_size, int hash_seed = 1000)
{
	d = _d;
	word_num = _word_num;
